...
>>>>>>> a2b10937f774879765d2241b171db3b4d8e7dc6d
...
>>>>>>> a2b10937f774879765d2241b171db3b4d8e7dc6d
  ...
  return (
    <Map
      usersPosition={{ lat, lng }}
      destinationPosition={{ lat: 6.245737, lng: 5.5734694 }}
    />
  )
}
...
function Map(props) {
  ...
  function postDest() {
    axiosPost('http://localhost/3001/travel', {
      location: props.usersPosition,
      destination: props.destinationPosition,
    })
  }
  return (
    <>
      <div className='places-container'>
        <button className='order-ride' onClick={postDest()}>
          Order Ride!
        </button>
      ...
      >
        <MarkerF
          position={JSON.parse(JSON.stringify(props.usersPosition))}
          icon={{
